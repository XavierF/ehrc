...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // register google fonts css
    wp_register_style( 'google-font', 'https://fonts.googleapis.com/css?family=Roboto:400,500,700,500italic|Roboto+Condensed:400,300,700' , array(), 'all' );
